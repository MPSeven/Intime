...
import kr.go.mapo.intime.databinding.FragmentFavoritePharmacyBinding
...
class FavoritePharmacyFragment : Fragment(){
    ...
    private var _binding: FragmentFavoritePharmacyBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFavoritePharmacyBinding.inflate(inflater, container, false)
